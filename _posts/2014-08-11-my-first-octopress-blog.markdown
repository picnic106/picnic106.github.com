...
{% codeblock lang:ruby windows的Devkit安装脚本 %}
d:
...
{% codeblock lang:Python 用命令行下载octopress源码 %}
d:
...
{% codeblock lang:Python 安装octopress依赖项 %}
d:
cd octopress
gem install bundler
bundle install
...
{% codeblock lang:Python github_pages设置 %}
d:
cd octopress
...
{% codeblock lang:Python 将静态站点发布到github %}
rake install  
rake generate  
rake deploy  
{% endcodeblock %}  
...
{% codeblock lang:YAML _config.yml例子 %}
...
{% codeblock lang:Python new_post命令 %}
...
{% codeblock lang:YAML YAML头信息categories配置 %}
    # One category
    tags: Sass
...
{% codeblock lang:Python 新建网页的rake命令 %}
...
{% codeblock lang:Python 部署到github %}
...
{% codeblock lang:Python 测试sshkey %}
...
{% codeblock lang:Python 解决报版本不一致脚本 %}
